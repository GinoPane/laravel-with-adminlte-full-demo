...
@section('content')
    ...
    <section class="content">
        <div class="row">
            <div class="col-md-3">
                <a href="/demo/mailbox-compose" class="btn btn-primary btn-block margin-bottom">Compose</a>
                        ...
                        <div class="table-responsive mailbox-messages">
                            <table class="table table-hover table-striped">
                                ...
                                <tr>
                                    ...
                                    <td class="mailbox-name"><a href="/demo/mailbox-read">Alexander Pierce</a></td>
